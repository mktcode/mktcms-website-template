...
Dann auf dem Server (eingerichtet mit `docs/nuxtapps.yml`) mit folgendem Befehl das Repo klonen, Service sowie Reverse Proxy anlegen, App starten und Zertifikat holen:
